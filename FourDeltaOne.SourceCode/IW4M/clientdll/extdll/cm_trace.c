...
================
*/
static void CM_TraceThroughVerticalCylinder(traceWork_t * tw, vec3_t origin, float radius, float halfheight, vec3_t start,
											vec3_t end)
{
...
//static vec3_t vec3_origin = {0.f, 0.f, 0.f};
