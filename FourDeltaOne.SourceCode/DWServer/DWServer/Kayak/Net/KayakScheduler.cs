...
namespace Kayak
{
    class DefaultKayakScheduler : IScheduler
    {
        ...
        {
            DWServer.Log.Debug("--- Posted task.");
        ...
        private void MainLoop()
        {
            ...
            while (true)
            {
                ...
                {
                    DWServer.Log.Debug("--- Executing Task ---");
                    try
                    {
                        outTask();
                    }
                    ...
                    {
                        DWServer.Log.Error(e.ToString());
                    }
                    DWServer.Log.Debug("--- Done Executing Task ---");
                    ...
                    if (stopped)
                    {
                        ...
                        DWServer.Log.Debug("Scheduler stopped.");
                        del.OnStop(this);
        ...
        public void Stop()
        {
            DWServer.Log.Debug("Scheduler will stop.");
            Post(() => { stopped = true; });
        }
