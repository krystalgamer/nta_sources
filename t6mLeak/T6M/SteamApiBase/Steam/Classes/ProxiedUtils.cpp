...
{
	//HHSDBG();
	return (uint32_t)((std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::high_resolution_clock::now() - Global::Variables::StartupPoint).count()) / 1000);
}
...
{
	//HHSDBG();
	return "IR"; // TODO: Query the master..
}
